    ...
    <View className={s['weui-form-preview']}>
      ...
      <View className="weui-form-preview__bd">
        <View className="weui-form-preview__item">
          ...
          <View className="weui-form-preview__value">{order.order_id}</View>
        </View>
        <View className="weui-form-preview__item">
        ...
        {(order.type === OrderType.TO_THE_STORE ||
          OrderType.APPOINTED_TIME) && (
          <View className="weui-form-preview__item">
      ...
      {!order.isShowDetail ? (
        <View
          className={s['view-detail']}
          data-idx={order.order_id}
      ...
      <View className="weui-form-preview__ft">
        ...
        {(order.status === OrderStatus.DONE || OrderStatus.CANCEL) && (
          <View
